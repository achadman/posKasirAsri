...
class _RegisterPageState extends State<RegisterPage> {
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  const Icon(Icons.person_add_alt_1_rounded, size: 80, color: Color(0xFFF0E8A7)),
  ...
  Widget _buildTextField(
    ...
    final bool safeObscureValue = isPassword ? (_obscurePassword ?? true) : false;
  ...
  Widget _buildRoleDropdown() {
    return Theme(
      data: Theme.of(context).copyWith(canvasColor: const Color(0xFF003566)),
      child: DropdownButtonFormField<String>(
        ...
        onChanged: (val) => setState(() => _selectedRole = val ?? 'kasir'),
        decoration: InputDecoration(
          prefixIcon: const Icon(Icons.badge_outlined, color: Color(0xFFF0E8A7)),
      ...
      child: ElevatedButton(
        ...
        child: _isLoading
            ? const SizedBox(
                height: 20, 
                width: 20, 
                child: CircularProgressIndicator(color: Color(0xFF001D3D), strokeWidth: 2)
              )
